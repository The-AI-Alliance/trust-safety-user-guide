...
[Adversarial Machine Learning: A Taxonomy and Terminology of Attacks and Mitigations](https://csrc.nist.gov/pubs/ai/100/2/e2025/final){:target="nist-aml"} is a more recent report in this series that offers a taxonomy and general guidance on the unique security challenges of [AI Systems]({{site.glossaryurl}}/#ai-systems){:target="_glossary"}.
