...
# About The AI Alliance and the AI Trust and Safety User Guide

This user guide is developed by the [Trust and Safety Work Group](https://thealliance.ai/focus-areas/trust-and-safety){:target="tands"} in [The AI Alliance](https://thealliance.ai){:target="ai-alliance"}.
